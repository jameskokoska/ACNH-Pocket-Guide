  ...
  render(){
    return(<>
      ...
      <View style={{height: 25}}/>
        ...
        <ProgressContainerToggle saveList={this.saveList} toggleEditMode = {this.toggleEditMode} editMode={this.state.editMode} enabled={!this.state.collectionSectionsDisabled.includes("photosCount")} keyName="photosCount" delay={this.getDelay("photosCount")} setPage={this.props.setPage} page={3} tab={0} color={colors.photosCollectionProgress[0]} backgroundColor={colors.white[global.darkMode]} textColor={colors.textBlack[global.darkMode]} percentage={this.state.photosPercentage} image={require("../assets/icons/portrait.png")} text={attemptToTranslate("Villager Photos") + " " + this.state.photosCount + "/" + this.state.photosCountTotal.toString()}/>
        <ProgressContainerToggle saveList={this.saveList} toggleEditMode = {this.toggleEditMode} editMode={this.state.editMode} enabled={!this.state.collectionSectionsDisabled.includes("postersCount")} keyName="postersCount" delay={this.getDelay("postersCount")} setPage={this.props.setPage} page={3} tab={0} color={colors.postersCollectionProgress[0]} backgroundColor={colors.white[global.darkMode]} textColor={colors.textBlack[global.darkMode]} percentage={this.state.postersPercentage} image={require("../assets/icons/poster.png")} text={attemptToTranslate("Posters") + " " + this.state.postersCount + "/" + this.state.postersCountTotal.toString()}/>        
