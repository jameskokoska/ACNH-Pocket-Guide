...
import {BackHandler, Image, TouchableNativeFeedback, Vibration, View, Dimensions, Text} from 'react-native';
    ...
    return(
      <View style={{backgroundColor:colors.lightDarkAccent[global.darkMode], height:"100%"}}>
        <WebView
          ...
          incognito
        />
        <BottomBar openMenu={()=>this.props.openMenu()} goBack={()=>this.webView.goBack()} goForward={()=>this.webView.goForward()}/>
