  ...
  render(){
    return <ScrollView>
      <FadeInOut fadeIn={true} duration={1000}>
        ...
        <SupportOption label="Coffee" image={require("../assets/icons/coffee3.png")} price={"$3.45"} descriptionShort={"Caffeine to stay awake!"}/>
        <SupportOption label="Cake" image={require("../assets/icons/cupcake.png")} price={"$10.50"} descriptionShort={"Something sweet to eat!"}/>
        <SupportOption label="Meal" image={require("../assets/icons/meal.png")} price={"$20.50"} descriptionShort={"Very yummy and filling!"}/>     
        ...
        <SupportOption label="Gold" image={require("../assets/icons/gold-medal.png")} price={"$10/month"} description="Get your name and custom player avatar in the About page of the app!"/>
        <SupportOption label="Diamond" image={require("../assets/icons/diamond-medal.png")} price={"$20/month"} description="Get your name and custom player avatar in the About page of the app!"/>
        ...
        <View style={{flexDirection:"row", alignItems:"center",justifyContent:"space-between"}}>
          <View style={{flexDirection:"row", justifyContent:"center", alignItems:"center"}}>
            ...
            <View style={{flexDirection:"column"}}>
              ...
              {this.props.descriptionShort ? <TextFont bold={true} style={{color:colors.textBlack[global.darkMode], marginLeft:15, fontSize: 12}}>{this.props.descriptionShort}</TextFont> : <></>}
            </View>
          </View>
