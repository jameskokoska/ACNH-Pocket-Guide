...
-Added more hidden setting: Reduce motion and animations
...
-Fixed event items page for Lunar New Year and other events
-Fixed Active Creatures time offset
-Fixed villager popup on calendar page
-
...
-
-Catalog scanner app now supported for more languages
...
-Not Collected (If the large green checkbox is not selected)
-Fully Collected Variations (If all variations are selected)
