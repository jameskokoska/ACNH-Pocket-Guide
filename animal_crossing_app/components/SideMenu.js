    ...
    return (
      <View style={{width: "100%", height:"100%", backgroundColor:colors.textWhite[global.darkMode]}}>
        <ScrollView>
          ...
          <SidebarElement image={require("../assets/icons/home.png")} title="Home" pageNum={0} setPage={this.props.setPage} currentPage={this.props.currentPage} backgroundColor={colors.selectHome[global.darkMode]} textColor={colors.textBlack[global.darkMode]} unselectedColor={colors.textWhite[global.darkMode]}/>
          ...
          <SidebarElement image={require("../assets/icons/package.png")} title="New Items" pageNum={17} setPage={this.props.setPage} currentPage={this.props.currentPage} backgroundColor={colors.selectAllItems[global.darkMode]} textColor={colors.textBlack[global.darkMode]} unselectedColor={colors.textWhite[global.darkMode]}/>
