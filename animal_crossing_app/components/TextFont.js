...
class TextFont extends PureComponent {
  ...
  render(){
    ...
    return <Text adjustsFontSizeToFit={this.props.adjustsFontSizeToFit} numberOfLines={this.props.numberOfLines!==undefined?this.props.numberOfLines:200} style={[this.props.style,{fontFamily: this.props.bold===true ? "ArialRoundedBold":"ArialRounded"}]}>{prefix+text+suffix}</Text>
  }
}
