...
televisionData = [
	...
	["shopping commercial", "shopping commercial", "shopping commercial", "shopping commercial", "shopping commercial", "—", "shopping commercial"], 
	["color bars", "color bars", "color bars", "color bars", "color bars", "—", "color bars"], 
	["—", "—", "—", "—", "—", "secret program", "—"], 
	["—", "—", "—", "—", "—", "static", "—"], 
...
for day in dayCol:
    ...
    for time in timeRow:
        ...
        timeIndex +=1
        currentEvent[0] = time
        currentEvent[1] = televisionData[timeIndex][dayIndex]
        outputDay.append(currentEvent)
    output.append(outputDay)
print(output)

flatten_list = lambda y:[x for a in y for x in flatten_list(a)] if type(y) is list else [y]

mylist = list(set(flatten_list(televisionData)))
#print(mylist)
for element in output[6]:
    #print (element[1])
    print()
