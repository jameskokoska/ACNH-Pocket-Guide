...
with open('data.json', encoding='utf-8-sig') as d:
    data = json.load(d)
with open('inputTranslation.json', encoding='utf-8-sig') as t:
...
with open('translatedVariants.json', 'w', encoding='utf8') as json_file:
    json.dump(outputVariantsPatterns, json_file, ensure_ascii=False,indent=2)
with open('translatedSpecialNPCs.json', 'w', encoding='utf8') as json_file:
    json.dump(outputSpecialNPCs, json_file, ensure_ascii=False,indent=2)
with open('translatedVillagerCatchPhrases.json', 'w', encoding='utf8') as json_file:
